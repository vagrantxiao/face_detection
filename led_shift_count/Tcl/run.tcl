...
###############################################################
set rfh [open "run.log" w]
set cfh [open "command.log" w]
set wfh [open "critical.log" w]
...
#### Run PR verify 
if {[llength $configurations] > 1 && ${run.prVerify}} {
...
if {[llength $configurations] > 0 && ${run.writeBitstream}} {
